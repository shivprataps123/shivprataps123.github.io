...
import "./Home.css";
let pdf =
  "https://drive.google.com/uc?export=download&id=1FDi6FTc3jF13LVBwpJlRNpdCgthyZ53k";
  ...
  return (
    <div id="home">
      <div className="name">
        ...
        <h1 className="text-color f7">I am Shiv Yadav</h1>
        <h1>
          <Typewriter
            className="auto-type"
            options={{
              strings: ["Frontend Engineer", "A Problem Solver."],
              autoStart: true,
              loop: true,
              deleteSpeed: 80,
            }}
        ...
        <a href={pdf} target="" rel="noreferrer" download>
